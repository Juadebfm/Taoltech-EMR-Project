...
function FeaturesCard({ className = "", cardText, cardTitle, cardImg }: Props) {
  return (
    <div
      className={`${className} border border-black/20 w-full sm:w-[280px] cursor-pointer hover:shadow-lg transition-all duration-150 h-max sm:h-[450px] px-8 py-14 flex flex-col items-center justify-between rounded-md`}
    >
